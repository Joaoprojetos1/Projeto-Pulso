    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        <View style={styles.cash}>
          ...
          <Text style={styles.cashValor}>{p30 ? brl(p30.projectedCents) : '—'}</Text>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chips}>
          <Chip rotulo="CICLO DE CAIXA" valor={ciclo !== null ? dias(ciclo) : '—'} />
          <Chip rotulo="MARGEM" valor={margem !== null ? pct(margem) : '—'} positivo />
          <Chip rotulo="RECEITA / MÊS" valor={receita !== null ? brl(receita) : '—'} />
          <Chip
            rotulo="MÊS ANTERIOR"
...
function Chip({ rotulo, valor, positivo }: { rotulo: string; valor: string; positivo?: boolean }) {
  return (
